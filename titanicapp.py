...
def PredictionFunction(Pclass, Sex, Age, SibSp, Parch, Fare, Embarked):
    try:
        ...
        print('Something went wrong. Contact IT support at +4323455667787.')
...
def main():
    ...
    with col2:
        SipSp = st.slider('Siblings/Spouses Aboard:', min_value=0, max_value=10, value=0)
    ...
    if st.button('Predict'):
        result = PredictionFunction(Pclass, Sex, Age, SipSp, Parch, Fare, Embarked) #result holds 0 or 1; the target value
        st.info(f'{result}')
